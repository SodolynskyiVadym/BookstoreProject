<template>
  ...
  <div class="create-book-section" v-if="loaded">
      ...
      <button @click="updateBook" :class="{ 'button-create': isActive, 'button-create-disabled': !isActive }" :disabled="!isActive">Update</button>
  </div>
</template>
